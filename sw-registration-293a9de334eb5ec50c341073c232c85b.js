(function(){"use strict"
var e=[],n=[]
"serviceWorker"in navigator&&navigator.serviceWorker.register("/monday-nightsw.js",{scope:"/monday-night"}).then(function(n){for(var r=Promise.resolve(),o=0;o<e.length;o++)(function(o){r=r.then(function(){return e[o](n)})})(o)
